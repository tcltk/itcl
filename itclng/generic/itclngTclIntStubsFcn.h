...
EXTERN int Itclng_PushCallFrame (Tcl_Interp * interp,
                Tcl_CallFrame * framePtr,
	        Tcl_Namespace * nsPtr, int isProcCallFrame);
EXTERN void Itclng_PopCallFrame (Tcl_Interp * interp);
EXTERN void Itclng_GetVariableFullName (Tcl_Interp * interp,
                Tcl_Var variable, Tcl_Obj * objPtr);
EXTERN Tcl_Var Itclng_FindNamespaceVar (Tcl_Interp * interp,
                CONST char * name, Tcl_Namespace * contextNsPtr, int flags);
EXTERN void Itclng_SetNamespaceResolvers (Tcl_Namespace * namespacePtr,
