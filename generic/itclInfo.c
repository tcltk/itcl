    ...
    Tcl_Obj *const objv[]) /* argument objects */
{
    ...
    ItclShowArgs(0, "Itcl_BiInfoDelegatedMethodCmd not yet implemented", objc, objv);
    return TCL_OK;
}

/*
    ...
    Tcl_Obj *const objv[]) /* argument objects */
{
    ...
    ItclShowArgs(0, "Itcl_BiInfoDelegatedTypeMethodCmd not yet implemented", objc, objv);
    return TCL_OK;
}
