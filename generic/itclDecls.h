 ...
 *
 * RCS: $Id: itclDecls.h,v 1.4 2001/11/24 22:55:56 davygrvy Exp $
 */
...
/* 13 */
TCL_EXTERN(Itcl_ListElem*)	Itcl_CreateListElem _ANSI_ARGS_((Itcl_List * listPtr));
/* 14 */
...
TCL_EXTERN(Itcl_ListElem*)	Itcl_InsertList _ANSI_ARGS_((Itcl_List * listPtr, 
				ClientData val));
/* 16 */
TCL_EXTERN(Itcl_ListElem*)	Itcl_InsertListElem _ANSI_ARGS_((Itcl_ListElem * pos, 
				ClientData val));
/* 17 */
TCL_EXTERN(Itcl_ListElem*)	Itcl_AppendList _ANSI_ARGS_((Itcl_List * listPtr, 
				ClientData val));
/* 18 */
TCL_EXTERN(Itcl_ListElem*)	Itcl_AppendListElem _ANSI_ARGS_((Itcl_ListElem * pos, 
				ClientData val));
/* 19 */
